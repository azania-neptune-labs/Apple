...
e.preventDefault();}});function setTeamMemberHeight(){$('.music-banner').height($('.music-banner').width());$('.music-banner-1').height($('.music-banner-1').width());$('.music-banner-2').height($('.music-banner-2').width());$('.music-banner-3').height($('.music-banner-3').width());$('.s-item-image').height($('.s-item-image').width());}
...
$("#popup-container").animate({opacity:0},300,function(){$(this).css("display","none");})});if($('.nav li.active').length==0){$('.nav li:first-child').addClass('active');}
...
$(".overly-1").animate({opacity:0},300,function(){$(this).css("display","none");});$("#text-and-video").css('position','relative');});$("body.single-events").on("click",function(event){event.stopPropagation();$(".overly-1").css("display","block").animate({opacity:1},300);$("#text-and-video").css('position','initial');});$(document).ready(msieversion);if(navigator.userAgent.search("NET")>=0){if(!Modernizr.objectfit){$('.music-banner .w-100').each(function(){var $container=$(this),imgUrl=$container.find('img').prop('src');if(imgUrl){$container.css('backgroundImage','url('+imgUrl+')').addClass('compat-object-fit');}});$('.embed-responsive .youtube').each(function(){var $container=$(this),imgUrl=$container.find('img').prop('src');if(imgUrl){$container.css('backgroundImage','url('+imgUrl+')').addClass('compat-object-fit');}});$('.video-block .video-img-banner').each(function(){var $container=$(this),imgUrl=$container.find('img').prop('src');if(imgUrl){$container.css('backgroundImage','url('+imgUrl+')').addClass('compat-object-fit');}});$('.grid-item-img').each(function(){var $container=$(this),imgUrl=$container.find('img').prop('src');if(imgUrl){$container.css('backgroundImage','url('+imgUrl+')').addClass('compat-object-fit');}});$('.blog-grid-image').each(function(){var $container=$(this),imgUrl=$container.find('img').prop('src');if(imgUrl){$container.css('backgroundImage','url('+imgUrl+')').addClass('compat-object-fit');}});$('.featured-image').each(function(){var $container=$(this),imgUrl=$container.find('img').prop('src');if(imgUrl){$container.css('backgroundImage','url('+imgUrl+')').addClass('compat-object-fit');}});$('.t-shirt-image').each(function(){var $container=$(this),imgUrl=$container.find('img').prop('src');if(imgUrl){$container.css('backgroundImage','url('+imgUrl+')').addClass('compat-object-fit');}});}}
